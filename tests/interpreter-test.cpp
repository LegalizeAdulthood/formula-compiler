...
static InterpreterParam s_formulas[]{
    ...
    {"globalSection", "global:1", Section::PER_IMAGE, 1.0, 0.0},                    //
    {"initSection", "init:2", Section::INITIALIZE, 2.0, 0.0},                       //
    {"loopSection", "loop:3", Section::ITERATE, 3.0, 0.0},                          //
    {"bailoutSection", "bailout:4", Section::BAILOUT, 4.0, 0.0},                    //
    {"perturbInitSection", "perturbinit:5", Section::PERTURB_INITIALIZE, 5.0, 0.0}, //
    {"perturbLoopSection", "perturbloop:6", Section::PERTURB_ITERATE, 6.0, 0.0},    //
};
