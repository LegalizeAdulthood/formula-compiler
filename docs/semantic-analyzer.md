...
2. Parameter-set binding model decision.
...
3. Formula semantic model decision.
...
4. Interpreter integration regression.
...
5. Compiler integration regression.
