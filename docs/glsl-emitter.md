...
### 1. Correct Modulus And Absolute Builtins
...
### 2. Correct Comparison Operators
...
### 4. Correct Conditional Emission
...
### 5. Implement Complete BASIC Builtin Mapping
...
### 7. Add Runtime-Selected `fn1` Through `fn4`
...
### 9. Add Remaining Predefined Variables
...
### 10. Define Section Result And Output ABI
...
### 11. Add GLSL Compile Validation
...
### 12. Add Interpreter Equivalence Fixtures
...
### 13. Remove Example-Only Caveats
