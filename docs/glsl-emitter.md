...
### 1. Replace Raw Arithmetic With Complex Helpers
...
### 2. Correct Modulus And Absolute Builtins
...
### 5. Correct Conditional Emission
...
### 6. Implement Complete BASIC Builtin Mapping
...
### 8. Add Runtime-Selected `fn1` Through `fn4`
...
### 10. Add Remaining Predefined Variables
...
### 11. Define Section Result And Output ABI
...
### 12. Add GLSL Compile Validation
...
### 13. Add Interpreter Equivalence Fixtures
...
### 14. Remove Example-Only Caveats
