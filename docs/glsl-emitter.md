...
### 1. Correct Comparison Operators
...
### 3. Correct Conditional Emission
...
### 4. Implement Complete BASIC Builtin Mapping
...
### 6. Add Runtime-Selected `fn1` Through `fn4`
...
### 8. Add Remaining Predefined Variables
...
### 9. Define Section Result And Output ABI
...
### 10. Add GLSL Compile Validation
...
### 11. Add Interpreter Equivalence Fixtures
...
### 12. Remove Example-Only Caveats
