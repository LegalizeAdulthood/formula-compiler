...
### 1. Implement Complete BASIC Builtin Mapping
...
### 3. Add Runtime-Selected `fn1` Through `fn4`
...
### 5. Add Remaining Predefined Variables
...
### 6. Define Section Result And Output ABI
...
### 8. Add Interpreter Equivalence Fixtures
