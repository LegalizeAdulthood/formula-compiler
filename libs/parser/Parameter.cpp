...
BasicParameterEntry BodyParser::parse_basic()
{
...
void BodyParser::parse_basic_line(BasicParameterEntry &entry, const ProcessedLine &processed)
{
...
void BodyParser::finish_layer(ExtendedParameterEntry &entry)
{
