...
const auto default_value_def =
    default_double | default_complex | default_string | default_int | default_method | default_periodicity;
...
BOOST_PARSER_DEFINE_RULES(number, variable, function_call, unary_op,           //
    ...
    default_method, default_periodicity,                                       //
    section_formula);
